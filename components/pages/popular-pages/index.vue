<template>
  <div>
    ...
    <w-container classes="pt-5 pb-12 mobile:px-0 mobile:pt-0">
      <div
        class="
          grid grid-cols-6
          mobile:grid-cols-12
      ...
      >
        <div class="col-span-4 tablet:col-span-3 mobile:col-span-full">
          ...
          >
            ...
            <p class="text-[18px] leading-[27px]">{{ description }}</p>
          </div>
          <div class="p-5 pb-8 border border-[#c4c4c4] rounded-[0.25rem] mb-4">
            <a
...
import popularPages from '~/config/popular-pages.json'
...
export default {
  ...
  data() {
    return {
      title: popularPages['popular-pages'].meta_title,
      description: popularPages['popular-pages'].text,
      urlList: popularPages['popular-pages'].url_list,
    }
  },
  head() {
    return {
